...
const MAP: Record<string, string> = {
  ...
  "Language": "ভাষা",
  "language selector": "but what about my previous messages, i have so many chats in my daatabase, but nothing is showing.\ni am giving you acces to my database, but nothng showing.\n\nand the claim you does, it not true, the chats still showing \"No messages yet\n\nSend the first message to start the conversation.\"\n\n\n\nthe compelete chat system to working after recent implementation of \"\n\nImplement real-time typing indicators and read previews for each participant.\n\nCreate conversation and message search with fast filtering and highlighting.\n\nAdd the ability to pin important messages per conversation for quick access.\n\nImplement message editing with version history and proper permissions.\n\n\"",
