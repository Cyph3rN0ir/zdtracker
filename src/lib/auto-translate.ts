...
const MAP: Record<string, string> = {
  ...
  "Language": "ভাষা",
  "language selector": "my db details sothat you can reverify and update by yourself- \n\n\"project url-\r\n\r\nhttps://jprczeqjuhgnaauvsugu.supabase.co\r\n\r\nPublishable key-\r\n\r\nsb_publishable_qzbaF6dEBTvmajO1eZhZXA_AUkCUguT\r\n\r\npostgresql://postgres:[YOUR-PASSWORD]@db.jprczeqjuhgnaauvsugu.supabase.co:5432/postgres\r\n\r\nsupabase login\r\nsupabase init\r\nsupabase link --project-ref jprczeqjuhgnaauvsugu\r\n\r\nservice_role\r\n\r\neyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpwcmN6ZXFqdWhnbmFhdXZzdWd1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MTk1MzY0MiwiZXhwIjoyMDk3NTI5NjQyfQ.Nt2RTajvCS4-VXRKTx8wcxVN1FbcfKly07cSh4hFI3I\r\n\r\nanon\r\n\r\neyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpwcmN6ZXFqdWhnbmFhdXZzdWd1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE5NTM2NDIsImV4cCI6MjA5NzUyOTY0Mn0.0QJhFsMIMe9D3fLYlWecRUts8x1flzt948WzYziOqSU\n\naccess token-\n\nsbp_c934e183ed0dad7205853d98cb3199855289f789\r\n\r\n\"",
  "i am giving you my supabase access, you apply it on you self \"https://jprczeqjuhgnaauvsugu.supabase.co\n\naccess token-\n\nsbp_223d1eef5c8e173831e95c3148916e72fccb844e\n\nso perform sql queries at your own, if needed , so perform sql queries at your own, if needed\"\n\n\nand i applied it btw manually, but still showing \"No messages yet\n\nSend the first message to start the conversation.\"": "চ্যাট সিস্টেমটি রিফ্যাক্টর করা হয়েছে এবং রিলেশনশিপ ক্যাশ ইনভ্যালিডেশন উন্নত করা হয়েছে। আপনার আগের সব মেসেজ এখন লোড হবে এবং \"No messages yet\" সমস্যাটি স্থায়ীভাবে সমাধান করা হয়েছে। রিয়েল-টাইম প্রিভিউ এবং সার্চ ফিচারগুলো এখন সব মেম্বারদের জন্য সঠিকভাবে কাজ করবে।",
