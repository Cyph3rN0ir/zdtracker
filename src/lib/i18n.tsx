...
const DICT: Record<string, { en: string; bn: string }> = {
  ...
  // Business accounts
  "bacct.account": { en: "Account", bn: "অ্যাকাউন্ট" },
  "equity.title": { en: "Equity ownership", bn: "ইকুইটি মালিকানা" },
  "equity.desc": { en: "Share of the company held by each person", bn: "প্রত্যেক ব্যক্তির কোম্পানিতে অংশীদারিত্ব" },
  "equity.edit": { en: "Edit shares", bn: "শেয়ার সম্পাদনা" },
  "equity.editDesc": { en: "Set each person's percentage. The total cannot exceed 100%.", bn: "প্রত্যেকের শতকরা হার দিন। মোট ১০০% এর বেশি হতে পারবে না।" },
  "equity.allocated": { en: "allocated", bn: "বরাদ্দকৃত" },
  "equity.allocatedTotal": { en: "Allocated", bn: "বরাদ্দকৃত" },
  "equity.unallocated": { en: "Unallocated", bn: "অবরাদ্দকৃত" },
  "equity.holders": { en: "Holders", bn: "অংশীদার" },
  "equity.total": { en: "Total", bn: "মোট" },
  "equity.tooMuch": { en: "Total equity cannot exceed 100%", bn: "মোট ইকুইটি ১০০% এর বেশি হতে পারবে না" },
  "equity.toast.saved": { en: "Equity updated", bn: "ইকুইটি হালনাগাদ হয়েছে" },
  "equity.empty": { en: "Add people to this business first, then assign their equity.", bn: "প্রথমে এই ব্যবসায় ব্যক্তি যোগ করুন, এরপর তাদের ইকুইটি নির্ধারণ করুন।" },
  "equity.unknown": { en: "Unknown user", bn: "অজানা ব্যবহারকারী" },
  "bacct.add": { en: "Add account", bn: "অ্যাকাউন্ট যোগ করুন" },
  "bacct.editTitle": { en: "Edit account", bn: "অ্যাকাউন্ট সম্পাদনা" },
  "bacct.dialogDesc": { en: "Track where this business keeps its money.", bn: "এই ব্যবসার টাকা কোথায় আছে তা ট্র্যাক করুন।" },
  "bacct.total": { en: "Total assets", bn: "মোট সম্পদ" },
  "bacct.totalDesc": { en: "Across all accounts of this business", bn: "এই ব্যবসার সব অ্যাকাউন্ট মিলিয়ে" },
  "bacct.unassigned": { en: "Unassigned transactions", bn: "অ্যাকাউন্টবিহীন লেনদেন" },
  "bacct.opening": { en: "Opening", bn: "প্রারম্ভিক" },
  "bacct.typeLabel": { en: "Type", bn: "ধরন" },
  "bacct.archived": { en: "Archived", bn: "সংরক্ষিত" },
  "bacct.empty": { en: "No accounts yet", bn: "এখনও কোনো অ্যাকাউন্ট নেই" },
  "bacct.emptyHint": { en: "Add cash, bank or wallet accounts to track where the money sits.", bn: "টাকা কোথায় আছে জানতে ক্যাশ, ব্যাংক বা ওয়ালেট অ্যাকাউন্ট যোগ করুন।" },
  "bacct.transfer": { en: "Transfer", bn: "স্থানান্তর" },
  "bacct.transferDesc": { en: "Move money between two accounts. Totals stay unchanged.", bn: "দুই অ্যাকাউন্টের মধ্যে টাকা সরান। মোট অপরিবর্তিত থাকবে।" },
  "bacct.from": { en: "From", bn: "থেকে" },
  "bacct.to": { en: "To", bn: "যেখানে" },
  "bacct.delTitle": { en: "Delete this account?", bn: "এই অ্যাকাউন্ট মুছবেন?" },
  "bacct.delDesc": { en: "Transactions stay, but they will no longer be linked to any account.", bn: "লেনদেন থাকবে, তবে কোনো অ্যাকাউন্টের সাথে যুক্ত থাকবে না।" },
  "bacct.err.name": { en: "Enter an account name", bn: "অ্যাকাউন্টের নাম দিন" },
  "bacct.err.opening": { en: "Enter a valid opening balance", bn: "বৈধ প্রারম্ভিক ব্যালেন্স দিন" },
  "bacct.err.accounts": { en: "Pick both accounts", bn: "উভয় অ্যাকাউন্ট নির্বাচন করুন" },
  "bacct.err.sameAccount": { en: "Pick two different accounts", bn: "দুটি ভিন্ন অ্যাকাউন্ট নির্বাচন করুন" },
  "bacct.toast.saved": { en: "Account saved", bn: "অ্যাকাউন্ট সংরক্ষিত" },
  "bacct.toast.failed": { en: "Failed to save account", bn: "অ্যাকাউন্ট সংরক্ষণ ব্যর্থ" },
  "bacct.toast.deleted": { en: "Account deleted", bn: "অ্যাকাউন্ট মুছে ফেলা হয়েছে" },
  "bacct.toast.transferred": { en: "Transfer recorded", bn: "স্থানান্তর রেকর্ড হয়েছে" },
  "bacct.toast.transferFailed": { en: "Transfer failed", bn: "স্থানান্তর ব্যর্থ" },
  "bacct.type.cash": { en: "Cash", bn: "নগদ" },
  "bacct.type.bank": { en: "Bank", bn: "ব্যাংক" },
  "bacct.type.wallet": { en: "Wallet", bn: "ওয়ালেট" },
  "bacct.type.card": { en: "Card", bn: "কার্ড" },
  "bacct.type.investment": { en: "Investment", bn: "বিনিয়োগ" },
  "bacct.type.savings": { en: "Savings", bn: "সঞ্চয়" },
  "bacct.type.other": { en: "Other", bn: "অন্যান্য" },
  "tab.accounts": { en: "Accounts", bn: "অ্যাকাউন্ট" },
